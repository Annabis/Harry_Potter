...
const templateElement = document.querySelector("#cardTemplate");
const sectionElement = document.querySelector(".cardsContainer");

const renderCard = (card) => {
  const cardElement = templateElement.content.cloneNode(true);

  const photoElement = cardElement.querySelector(".photo");
  photoElement.src = card.image;
  const nameElement = cardElement.querySelector(".card__name");
  nameElement.textContent = card.name;
  const actorElement = cardElement.querySelector(".card__actor");
  actorElement.textContent = "Actor: " + card.actor;
  const genderElement = cardElement.querySelector(".card__gender");
  genderElement.textContent = "Gender: " + card.gender;
  const houseElement = cardElement.querySelector(".card__house");
  houseElement.textContent = "House: " + card.house;
  const wand_coreElement = cardElement.querySelector(".card__wand");
  wand_coreElement.textContent = "Wand core: " + card.wand.core;
  const aliveElement = cardElement.querySelector(".card__alive");
  aliveElement.textContent = "Alive: " + (card.alive ? "yes" : "no");
...
select.addEventListener("change", () => {
  ...
  const result = handleSerch(query, house);
  renderCards(result);
});
